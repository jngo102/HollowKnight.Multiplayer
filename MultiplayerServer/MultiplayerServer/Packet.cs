...
namespace MultiplayerServer
{
    ...
    public enum ClientPackets
    {
        ...
        WeaverTexture,
        WraithsTexture,
        BaldurTextureUpToDate,
        FlukeTextureUpToDate,
        GrimmTextureUpToDate,
        HatchlingTextureUpToDate,
        KnightTextureUpToDate,
        ShieldTextureUpToDate,
        SprintTextureUpToDate,
        UnnTextureUpToDate,
        VoidTextureUpToDate,
        VSTextureUpToDate,
        WeaverTextureUpToDate,
        WraithsTextureUpToDate,
        PlayerPosition,
        PlayerScale,
        PlayerAnimation,
        SceneChanged,
